...
# best_cross_over_points = np.loadtxt('content.txt')
np.savetxt('content.txt',best_cross_over_points)
...
plt.imshow(final_output[15])
plt.show()
plt.imsave('img11.jpg', final_output[15], cmap='gray', vmin=0, vmax=255)
x=0
acc=0
n=0
while x<99:
